            ...
            <div class="col-sm-3 com-w3ls">
                <section class="panel">
                    <div class="panel-body">
                        <a onclick="$('#messenger').parent().removeClass('hidden'); $('#messenger').focus();$(this).hide(); $('#submit').parent().removeClass('hidden'); $('#submit').focus();" href="javascript:;"  class="btn btn-compose">
                            Gửi tin nhắn
                        </a>
            ...
            <h3>Trả lời</h3><br>
                ...
                <form id="idForm">
                    ...
                    <div class="form-group hidden">
                        ...
                        <br>
                        <label for="{{$idStudent}}" class=""></label>
